...
public class UserDAO implements IUserDAO {
    private String jdbcURL = "jdbc:mysql://localhost:3306/bt1";
    private String jdbcUsername = "root";
    private String jdbcPassword = "duyfx123";

    private static final String INSERT_USERS_SQL = "INSERT INTO users   m  (name, email, country) VALUES (?, ?, ?);";
